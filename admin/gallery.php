...
<div class="table-container">
    ...
    try {
        $connection = new PDO("mysql:host=$servername;dbname=tours", $username, $password);
        $connection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

        $sql = "SELECT gallery_id, images, name, description FROM gallery";
        ...
        foreach ($results as $result) {
            ...
            <table class="tour-table">
                <thead>
                <tr>
                    <th colspan="3">Gallery Details</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td rowspan="3" class="image-cell">
                        <img src="<?php echo $imageSrc; ?>" alt="Gallery Image" style="max-width: 100px;">
                    </td>
                    <td><strong>Gallery ID:</strong> <?php echo $gallery_id; ?></td>
                </tr>
                <tr>
                    <td><strong>Name:</strong> <?php echo $result['name']; ?></td>
                </tr>
                <tr>
                    <td colspan="2"><strong>Description:</strong> <?php echo $result['description']; ?></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <button class='edit'
                                onclick="window.location.href = 'galleryEdit.php?id=<?php echo $gallery_id; ?>'">Edit
                        </button>
                        <button class='remove'
                                onclick="window.location.href = 'removeGallery.php?id=<?php echo $gallery_id; ?>'">Remove
                        </button>
                    </td>
                </tr>
                </tbody>
