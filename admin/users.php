...
try {
    ...
    foreach($results as $result){
        echo "<tr>
            ...
            <td><button class='edit'><a href='EditUserPage.php?id={$result['id']}'>Edit</a></button></td>
            <td><button class='remove'><a href='RemoveUserPage.php?id={$result['id']}'>Remove</a></button></td>
        </tr>";
    }
